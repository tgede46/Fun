import type { UMLAggregationObject, UMLCompositionObject, UMLDependencyObject, UMLNotesLinkObject } from "../types";
  ...
  return (
    <g opacity={obj.opacity} data-object-id={obj.id}>
      <line
        ...
        opacity={obj.opacity}
      />
      <circle cx={start.x} cy={start.y} r={2} fill={obj.stroke} stroke="none" opacity={obj.opacity} />
      <circle cx={end.x} cy={end.y} r={2} fill={obj.stroke} stroke="none" opacity={obj.opacity} />
